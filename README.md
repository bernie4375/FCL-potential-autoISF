...
Section 00_ introduces you to the principle idea, and routes taken, to approach Full Closed Looping (FCL), which means doing no more carb inputs, and the loop doing all necessary bolussing automatically.
...
Nothing in this site is medical advice, but meant to stimulate patient-driven self-responsible research, and is meant also to stimulate product development by the medical industry. Anything you try to conclude for yourself you do on own risk. This is by no means a medical product but **what is offered is a toolset for participating in development. 
